...
const SingleTodo:React.FC<SingleTodoProps> = ({todo, dispatch}: SingleTodoProps) => {
  ...
  return (
    <form className= { `todos__single ${todo.isDone && "todos__complete"}`} onSubmit={(e)=>handleEdit(e, todo.id)}>
      {
        isEdit ? (
